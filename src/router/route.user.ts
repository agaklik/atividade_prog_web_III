...
//MÉTODO DE SACAR DINHEIRO PELO ID;
...
//QUANDO O USUÁRIO É ENCONTRADO;
    ...
    let operacao = userExist.operacao;
    operacao.push({tipo, valor});

    let saldo = userExist.saldo;
    database.update(table, id, {id, nome, saldo: saldo - Number(valor), operacao});
